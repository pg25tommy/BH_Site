...
export default function MileHighClubPage() {
  return (
    <div className="bg-wood-100 min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-accent-600 to-accent-800 text-white py-20 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="text-6xl md:text-8xl font-heading mb-4 text-accent-200" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
              $72.69
            </div>
          ...
          <div className="bg-gradient-to-r from-accent-500 to-accent-600 rounded-2xl shadow-lg p-8 md:p-12 text-white mb-12 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl mb-2">Free Meal</h3>
                  <p className="leading-relaxed">The burger is on us if you complete the challenge!</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-white/20 rounded-full p-3 flex-shrink-0">
